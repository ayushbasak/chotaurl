    ...
    return (
        <div className="flex flex-col lg:flex-row jusitify-between items-evenly p-2 bg-white h-auto lg:h-4/6">
            ...
            <div className="flex flex-col w-full justify-center items-center">
                ...
                <input onChange = {flavorHandler} className = "shadow-xl w-11/12 lg:w-5/12 px-10 py-5 m-2 text-lg focus:outline-none rounded border-l-8 border-red-300" placeholder ="flavor string" value={flavor}></input>
