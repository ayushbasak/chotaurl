...
const Main = ({chandler, post, final, copy})=>{
    return (
        <div className="flex flex-col jusityf-center items-center p-2 bg-red-100 h-4/6">
            ...
            <span className="bg-yellow-400 p-7 w-80 lg:w-5/12 text-center m-2 font-bold text-lg text-white rounded flex flex-row justify-center items-center lg:flex-shrink-0">
                {final}
