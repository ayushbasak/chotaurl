...
const Main = ({chandler, post, final, copy})=>{
    return (
        <div className="flex flex-col jusitify-center items-center p-2 bg-white h-3/6 lg:h-4/6">
            ...
            <span className=" shadow-xl bg-yellow-400 p-7 w-80 lg:w-5/12 text-center m-2 font-bold text-sm lg:text-xl text-white rounded flex flex-row justify-center items-center lg:flex-shrink-0 border-l-8 border-blue-300">
