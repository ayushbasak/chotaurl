const About = ()=>{
    return (
        <div className="w-full lg:w-5/12 md:w-7/12 bg-blue-400 h-auto p-4 lg:m-3 py-10 rounded-lg shadow-xl text-white text-center">
            ...
            <p className="bg-green-600 p-3 m-3 rounded-xl">You may need to wait a few of seconds
            ...
            <p className="flex flex-col">Build your own URL shortener application using the 
                <a className="m-3 px-2 py-5 font-bold text-2xl bg-blue-500 hover:bg-blue-600 rounded-xl" href="https://github.com/ayushbasak/chotaurl-api">ChotaURL-api</a>
            </p>
        </div>
    );
}
