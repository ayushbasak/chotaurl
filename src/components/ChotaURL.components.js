    ...
    return (
        <div className="flex flex-col lg:flex-row jusitify-between items-evenly p-2 h-auto lg:h-4/6">
            ...
            <div className="flex flex-col w-full justify-center items-center">
                ...
                <button onClick = {post} className="shadow-xl bg-green-500 p-3 text-white w-11/12 lg:w-5/12 hover:bg-green-600 rounded border-l-8 border-red-400">Create</button>
                <span className=" shadow-xl bg-indigo-400 p-7 w-80 lg:w-5/12 text-center m-2 font-bold text-sm lg:text-xl text-white rounded flex flex-col lg:flex-row justify-center items-center lg:flex-shrink-0 border-l-8 border-red-400">
